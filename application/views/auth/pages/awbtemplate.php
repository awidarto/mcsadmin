    ...
    $(document).ready(function() {
        ...
        $('#download-csv').on('click',function(){
            ...
            if($('#merchant_id').val() == ''){
                ...
                $.post('<?php print base_url() ?>admin/dl/awbtemplate',
                    {
            ...
            <td>
                ...
                <table style="width:500px;" id="recon_select" cellspacing="0" >
                    ...
                    <tr class="dark">
                        ...
                        <td><span id="get_date_range" class="button action_link" style="cursor:pointer;">Filter</span></td>
                    </tr>
                    <tr>
                        <td colspan="4">&nbsp;</td>
                    </tr>
