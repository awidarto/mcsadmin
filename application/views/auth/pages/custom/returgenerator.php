<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#inv_generate').on('click',function(){
            ...
            $.post( base + 'custom/retur/genreport',
                params,
                function(data){
                    if(data.result == 'OK'){
...
<?php
    ...
    $opts = array('Global'=>'Global','Logistik'=>'Logistik','Courier'=>'Courier');
                ...
                <tr>
                    <td>
                        ...
                        <table style="width:500px;" id="recon_select" cellspacing="0" >
                            ...
                            <tr>
                                <td><?php print (isset($merchant_select_title))?$merchant_select_title:'Logistik'; ?></td>
                    ...
                    <td style="vertical-align:top;">
                        ...
                        <table style="width:500px;" id="recon_select" cellspacing="0" >
                            <tr>
                                ...
                                &nbsp;&nbsp;<span id="generatinginvoice" style="display:none;">Creating document...</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
